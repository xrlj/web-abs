...
import {DptManageService} from '../dpt-manage/dpt-manage.service';
...
export class RoleManageComponent implements OnInit {
  ...
  constructor(private commonService: CommonService, private utils: Utils,
              ...
              private defaultBusService: DefaultBusService, private departmentService: DptManageService) {
  }
  ...
  addRole(): void {
    ...
    this.commonService.getMenuList(Constants.appInfo.clientId, 0).ok(data => {
  ...
  editRole(id: string): void {
    ...
    this.roleManageService.getRoleInfo(id)
      .ok(data => {
        ...
        // 设置菜单授权
        this.commonService.getMenuList(Constants.appInfo.clientId, 0)
          .ok(data1 => {
