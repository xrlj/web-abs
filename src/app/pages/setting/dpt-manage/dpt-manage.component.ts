...
@Component({
  selector: 'app-dpt-manage',
  templateUrl: './dpt-manage.component.html',
  styleUrls: ['./dpt-manage.component.less']
})
export class DptManageComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private departmentService: DptManageService,
              private uiHelper: UIHelper, public uiTableHelper: UiTableHelper,
              private utils: Utils) { }

  ngOnInit(): void {
    this.addOrEditForm = this.fb.group({
      name: [null, [MyValidators.required]],
      parentDept: [null, null],
      sort: [null, [MyValidators.required]]
    });
