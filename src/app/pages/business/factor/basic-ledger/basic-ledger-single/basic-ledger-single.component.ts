...
// 基础台账列表-单笔融资
@Component({
  selector: 'app-basic-ledger-single',
  templateUrl: './basic-ledger-single.component.html',
  styleUrls: ['./basic-ledger-single.component.less']
})
export class BasicLedgerSingleComponent implements OnInit {
