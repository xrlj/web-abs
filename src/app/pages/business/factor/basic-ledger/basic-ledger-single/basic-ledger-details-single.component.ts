...
// 基础台账详情列表-单笔融资
@Component({
  selector: 'app-basic-ledger-details-single',
  templateUrl: './basic-ledger-details-single.component.html',
  styleUrls: ['./basic-ledger-details-single.component.less']
})
export class BasicLedgerDetailsSingleComponent implements OnInit {
